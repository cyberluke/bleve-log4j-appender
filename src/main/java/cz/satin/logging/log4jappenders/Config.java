...
public class Config {
	...
	protected static final String DEFAULT_LOG_APPENDER_NAME = "BleveAppender";
	protected static final String DEFAULT_URL = "http://localhost:8095";
	...
	public static String retrieveInstanceId() {
		...
		try {
			...
			System.out.println(new SimpleDateFormat("yyyy.MM.dd HH.mm.ss").format(new Date()) +
					" BleveAppender: Could not connect to AWS instance metadata service, using " + hostId + " for the hostId.");
		}
		return hostId;
	}
}
